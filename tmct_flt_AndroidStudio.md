...
# Overview  
#### 目的 : Android / iOS 共用環境での Mobileアプリケーション開発、<br>　　　　リハビリテーション / フィットネス 支援アプリケーション <br> 内容 : **Android** / **iOS** 共用開発環境を構築し、アプリケーション開発を行う。 <br>　　　　搭載機能を厳選し、操作の簡易性とリソース消費の最適化（低メモリ・コンパクトなアプリ容量）を重視した構成としています。  
